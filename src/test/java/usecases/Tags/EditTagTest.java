...
public class EditTagTest {
    ...
    /**
     * Tests editing a tag through the use case
     */
    @Test
    public void TestEditTag() {
        ...
        editTag.editTagColor(tagRequestModel2);
        ArrayList<Color> tagColours = new ArrayList<>();
        user.getTags().forEach((tag) -> tagColours.add(tag.getColor()));
        assertTrue(tagColours.contains(Color.ORANGE));
