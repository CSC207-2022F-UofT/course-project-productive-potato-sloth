...
public class HistogramPanel extends JPanel
{
    ...
    public static void createAndShowGUI(int monday, int tuesday, int wednesday, int thursday,
                                        int friday, int saturday, int sunday)
    {
        ...
        panel.addHistogramColumn("Sunday", sunday, Color.GREEN);
    ...
    public static void main(String[] args)
    {
        EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                createAndShowGUI(12, 15, 1, 14, 2, 33, 9);
            }
        });
    }
}
